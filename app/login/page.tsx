      ...
      <div className="max-w-[400px] mx-auto px-4">
        ...
        <div className="mb-6">
          ...
          <div className="text-sm text-[#424242] mt-1">
            New member?{" "}
            <Link href="/register" className="text-[#1a9cb7] hover:underline">
              Register
            </Link>{" "}
            here.
          </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                  <path d="M12 2.039C6.5 2.039 2 6.539 2 12.039c0 5.083 3.766 9.283 8.656 9.945v-7.05h-2.61v-2.895h2.61v-2.222c0-2.576 1.536-3.992 3.882-3.992 1.127 0 2.308.2v2.532h-1.3c-1.28 0-1.68.795-1.68 1.61v1.872h2.86l-.458 2.895h-2.402v7.05c4.89-.662 8.656-4.862 8.656-9.945 0-5.5-4.5-10-10-10z"/>
                </svg>
                Facebook
              </button>
